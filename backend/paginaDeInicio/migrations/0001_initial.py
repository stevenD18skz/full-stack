    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_type_user', models.CharField(choices=[('CC', 'Cédula de Ciudadanía'), ('CE', 'Cédula de Extranjería'), ('PA', 'Pasaporte')], max_length=2)),
                ('doc_number_user', models.CharField(max_length=20)),
                ('gender_user', models.CharField(choices=[('F', 'Femenino'), ('M', 'Masculino')], max_length=1)),
                ...
                ('role_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='paginaDeInicio.role')),
