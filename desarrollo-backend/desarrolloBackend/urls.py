...
from paginaDeInicio.views import UsuarioViewSet, LoginView, buscar_usuarios, inhabilidar_usuario
...
urlpatterns = [
  ...
  path('api/usuarios/inhabilitar/', inhabilidar_usuario.as_view()),
]