...
export function UsersList() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://127.0.0.1:8000/crear-usuario/', formData).then(response => {
  ...
  return (
    <div className=" relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <form className="p-4 md:p-5" onSubmit={handleSubmit}>
                ...
                <div className="m-4 grid gap-4 mb-4 grid-cols-2">
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5 " placeholder="Nombres"
                      required />
                  </div>
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Apellidos"
                      required>
                    </input>
                  </div>
                </div>
                ...
                <div className="m-4 grid gap-4 mb-4 grid-cols-2">
                  ...
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Teléfono"
                      required>
                    </input>
                  </div>
                </div>
                <div className="col-span-2 sm:col-span-1">
                  <label htmlFor="direccion" className="block mb-2 text-sm font-medium">Dirección</label>
                  <input
                    type="address"
                    id="direccion"
                    name="direccion"
                    ...
                    onChange={handleChange}
                    className="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-11/12 p-2.5" placeholder="Dirección"
                    required>
                  </input>
                </div>
                <div className="col-span-2 sm:col-span-1">
                  <div className="m-4 grid gap-4 mb-4 grid-cols-2">
                    <div className="col-span-2 sm:col-span-1">
                      <label htmlFor="rol" className="block mb-2 text-sm font-medium">Tipo de usuario</label>
                      <select
                        id="rol"
                        name="rol"
                        value={formData.rol}
              ...
              <button
                type="submit" className="inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-900 dark:hover:bg-blue-800 dark:focus:ring-blue-800 text-white">
      ...
      <div className="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
        ...
        <div>
          <button type="button" onClick={openCreate} className="text-gray-900 hover:text-white border hover:bg-gray-700 font-semibold rounded-full text-sm px-3 py-2 text-center me-2 mb-2 dark:border-gray-600  dark:text-white dark:bg-gray-600">
      ...
      {isOpenEdit && (
        <div className="modal">
          <div className="modal-content">
            ...
            <form className="p-4 md:p-5" onSubmit={handleSubmit}>
              <div className="gap-4 mb-4 grid-cols-2">
                <h3 className='pb-8 text-3xl'>Trabajador {seleccionado.first_name}</h3>
                <div className="col-span-2">
                  <label htmlFor="user" className=" block mb-2 text-sm font-medium">Nombre de Usuario</label>
                  <input
                    type="text"
